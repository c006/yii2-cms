...
<div class="cms-index">
    ...
    <div class="item-container margin-top-30 margin-bottom-20">
            ...
            <?= Html::a(Yii::t('app', 'Create Page'), ['create'], ['class' => 'btn btn-primary']) ?>
            ...
            <?= Html::a(Yii::t('app', 'How it works'), ['/cms/instructions'], ['class' => 'float-right btn btn-secondary']) ?>
            ...
            'columns'      => [
                ...
                [
                    ...
                    'value'     => function ($model) {
                        ...
                        $html .= Html::a(Yii::t('app', 'edit'), ['/cms/sections/index', 'CmsSections[cms_id]' => $model->id, 'sort' => 'position'], ['class' => 'btn btn-secondary']);
                        $html .= ' ' . Html::a(Yii::t('app', 'files'), ['/cms/files/index', 'CmsSections[cms_id]' => $model->id], ['class' => 'btn btn-secondary']);
                        $html .= '</div>';
